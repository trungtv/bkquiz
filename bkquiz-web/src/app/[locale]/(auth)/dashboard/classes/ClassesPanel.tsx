    ...
    <div className="space-y-7">
      ...
      <Card className="p-5 md:p-6">
        <div className="flex items-center justify-between">
          <div>
            <div className="text-lg font-semibold text-text-heading">Danh sách lớp</div>
          </div>
        </div>
              ...
              <div className="mt-4 space-y-2">
                {classes.map(c => (
                  <Link key={c.id} href={`/dashboard/classes/${c.id}`}>
                    <div className="rounded-md border border-border-subtle bg-bg-section transition-colors hover:border-border-strong">
